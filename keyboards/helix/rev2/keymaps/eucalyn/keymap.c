...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* Qwerty
    ...
    * | Shift|   Z  |   X  |   C  |   V  |   B  |   [  |   ]  |   N  |   M  |   ,  |   .  |   /  |  -   |
    * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
    * |  `   |Alt+; | LGUI | LALT |LowMhe|CmdSpc|SftSpc|  BS  | Enter|RseHen| RSFT |Finder|iTerm2|Alfred|
    * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      KC_GRV,LALT(KC_SCLN),KC_LGUI,KC_LALT,LT(_LOWER,KC_LANG2),LGUI_T(KC_SPC),LSFT_T(KC_SPC), \
                                                     KC_BSPC,KC_ENT,LT(_RAISE,KC_LANG1),KC_RSFT,RSFT(KC_F),LALT(KC_SPC),LGUI(KC_SPC) \
      ),
  ...
  */
  [_EUCALYN] = KEYMAP( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_W,   KC_LBRC, KC_RBRC,  KC_B,    KC_H,    KC_J,    KC_L,    KC_SCLN, KC_MINS, \
      KC_GRV,LALT(KC_SCLN),KC_LGUI,KC_LALT,LT(_LOWER,KC_LANG2),LGUI_T(KC_SPC),LSFT_T(KC_SPC), \
                                                     KC_BSPC,KC_ENT,LT(_RAISE,KC_LANG1),KC_RSFT,RSFT(KC_F),LALT(KC_SPC),LGUI(KC_SPC) \
      ),
   ...
   * |   ~  |  !   |  @   |  #   |  $   |  %   |             |  ^   |  &   |  *   |  (   |  )   |  |   |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      |  {   |  }   |  ESC |      |             | Left | Down | Up   | Right| PgUp | Home |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |  [   |  ]   |  (   |  )   |  (   |  )   | Home | PgDn | PgUp |  End | PgDn | End  |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |CapsLk|      |      |      |      |      |      |  Del |      |Adjust|      |      |      |      |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_LOWER] = KEYMAP( \
      ...
      _______, _______, KC_LCBR, KC_RCBR, KC_ESC,  _______,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PGUP, KC_HOME, \
      _______, _______, KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, KC_LPRN, KC_RPRN, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_PGDN, KC_END, \
      KC_LCAP, _______, _______, _______, _______, _______, _______, KC_DEL,  _______, ADJUST,  _______, _______, _______, _______ \
      ),
   ...
   * |   `  |  1   |  2   |  3   |  4   |  5   |             |  6   |  7   |  8   |  9   |  0   |  \   |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |             | Prev | Play | Next | Vol+ |      |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
  ...
  [_RAISE] = KEYMAP( \
      ...
      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                     KC_MRWD, KC_MPLY, KC_MFFD, KC_VOLU, _______, _______, \
      KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, _______, _______, KC_MUTE, KC_VOLD, _______, _______, \
   ...
   * |      | Reset|RGBRST|      |      | Win  |             |      |      |      |      |      |      |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | HUE+ | SAT+ | VAL+ |Aud on|Audoff| Mac  |             | Win  |Qwerty|Eucaly|      |      |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   ...
   */
  [_ADJUST] =  KEYMAP( \
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, EUCALYN,  QWERTY,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
      XXXXXXX, RESET,   RGBRST,  XXXXXXX, XXXXXXX, AG_SWAP,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
      RGB_HUI, RGB_SAI, RGB_VAI, AU_ON,   AU_OFF,  AG_NORM,                   AG_SWAP, QWERTY,  EUCALYN, XXXXXXX, XXXXXXX, XXXXXXX, \
